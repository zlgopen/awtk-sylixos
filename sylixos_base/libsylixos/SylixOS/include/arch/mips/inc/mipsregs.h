...
#define MIPS_ENTRYLO_XI     (_ULCAST_(1) << (_MIPS_SZLONG - 2))
#define MIPS_ENTRYLO_RI     (_ULCAST_(1) << (_MIPS_SZLONG - 1))
...
#define EXCCODE_CACHEERR    30  /* Cache error exception */
...
#define MIPS_MAAR_ADDR      ((BIT_ULL(_MIPS_SZLONG - 12) - 1) << 12)
 ...
 */
static inline int mm_insn_16bit(UINT16 insn)
{
    UINT16 opcode = (insn >> 10) & 0x7;
