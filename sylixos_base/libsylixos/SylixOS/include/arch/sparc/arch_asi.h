...
#ifndef __SPARC_ARCH_ASI_H
#define __SPARC_ARCH_ASI_H
...
#define ASI_M_TXTC_DATA             0x0e                    /*  Instruction Cache Data; rw, ss          */
...
#define ASI_BLK_INIT_QUAD_LDD_AIUS  0x23                    /*  (NG) init-store, twin load, secondary,  */
                                                            /*  user                                    */
...
#define ASI_BLK_INIT_QUAD_LDD_P	    0xe2                    /*  (NG) init-store, twin load, primary,    */
                                                            /*  implicit                                */
#define ASI_BLK_INIT_QUAD_LDD_S	    0xe3                    /*  (NG) init-store, twin load, secondary,  */
                                                            /*  implicit                                */
