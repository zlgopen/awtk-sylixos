...
*********************************************************************************************************/
#define PCI_BASE_CLASS_MASK                         0xff0000
#define PCI_SUB_CLASS_MASK                          0x00ff00
#define PCI_PROG_IF_MASK                            0x0000ff

#define PCI_BASE_CLASS_NOT_DEFINED                  0x00        /* Unclassified device                  */
#define PCI_CLASS_NOT_DEFINED_NON_VGA               0x0000      /* Non-VGA unclassified device          */
#define PCI_CLASS_NOT_DEFINED_VGA                   0x0001      /* VGA compatible unclassified device   */

#define PCI_BASE_CLASS_STORAGE                      0x01        /* Mass storage controller              */
#define PCI_CLASS_STORAGE_SCSI                      0x0100      /* SCSI storage controller              */
#define PCI_CLASS_STORAGE_IDE                       0x0101      /* IDE interface                        */
#define PCI_CLASS_STORAGE_IDE_OPERATING_PRIMARY     0x010100    /* Operating mode (primary)             */
#define PCI_CLASS_STORAGE_IDE_PROG_PRIMARY          0x010101    /* Programmable indicator (primary)     */
#define PCI_CLASS_STORAGE_IDE_OPERATING_SECONDARY   0x010102    /* Operating mode (secondary)           */
#define PCI_CLASS_STORAGE_IDE_PROG_SECONDARY        0x010103    /* Programmable indicator (secondary)   */
#define PCI_CLASS_STORAGE_IDE_MASTER_IDE_DEVICE     0x010107    /* Master IDE device                    */
#define PCI_CLASS_STORAGE_FLOPPY                    0x0102      /* Floppy disk controller               */
#define PCI_CLASS_STORAGE_IPI                       0x0103      /* IPI bus controller                   */
#define PCI_CLASS_STORAGE_RAID                      0x0104      /* RAID bus controller                  */
#define PCI_CLASS_STORAGE_ATA                       0x0105      /* ATA controller                       */
#define PCI_CLASS_STORAGE_ATA_ADMA_SINGLE           0x010520    /* ADMA single stepping                 */
#define PCI_CLASS_STORAGE_ATA_ADMA_CONTINUOUS       0x010530    /* ADMA continuous operation            */
#define PCI_CLASS_STORAGE_SATA                      0x0106      /* SATA controller                      */
#define PCI_CLASS_STORAGE_SATA_VENDOR_SPECIFIC      0x010600    /* Vendor specific                      */
#define PCI_CLASS_STORAGE_SATA_AHCI                 0x010601    /* AHCI 1.0                             */
#define PCI_CLASS_STORAGE_SATA_SERIAL_STORAGE_BUS   0x010602    /* Serial Storage Bus                   */
#define PCI_CLASS_STORAGE_SAS                       0x0107      /* Serial Attached SCSI controller      */
#define PCI_CLASS_STORAGE_SAS_SERIAL_STORAGE_BUS    0x010701    /* Serial Storage Bus                   */
#define PCI_CLASS_STORAGE_NVM                       0x0108      /* Non-Volatile memory controller       */
#define PCI_CLASS_STORAGE_NVM_HCI                   0x010801    /* NVMHCI                               */
#define PCI_CLASS_STORAGE_NVM_EXPRESS               0x010802    /* NVM Express                          */
#define PCI_CLASS_STORAGE_OTHER                     0x0180      /* Mass storage controller              */

#define PCI_BASE_CLASS_NETWORK                      0x02        /* Network controller                   */
#define PCI_CLASS_NETWORK_ETHERNET                  0x0200      /* Ethernet controller                  */
#define PCI_CLASS_NETWORK_TOKEN_RING                0x0201      /* Token ring network controller        */
#define PCI_CLASS_NETWORK_FDDI                      0x0202      /* FDDI network controller              */
#define PCI_CLASS_NETWORK_ATM                       0x0203      /* ATM network controller               */
#define PCI_CLASS_NETWORK_ISDN                      0x0204      /* ISDN controller                      */
#define PCI_CLASS_NETWORK_WORLDFIP                  0x0205      /* WorldFip controller                  */
#define PCI_CLASS_NETWORK_PICMG                     0x0206      /* PICMG controller                     */
#define PCI_CLASS_NETWORK_INFINIBAND                0x0207      /* Infiniband controller                */
#define PCI_CLASS_NETWORK_FABRIC                    0x0208      /* Fabric controller                    */
#define PCI_CLASS_NETWORK_OTHER                     0x0280      /* Network controller                   */

#define PCI_BASE_CLASS_DISPLAY                      0x03        /* Display controller                   */
#define PCI_CLASS_DISPLAY_VGA                       0x0300      /* VGA compatible controller            */
#define PCI_CLASS_DISPLAY_VGA_VGA_CONTROLLER        0x030000    /* VGA controller                       */
#define PCI_CLASS_DISPLAY_VGA_8514_CONTROLLER       0x030001    /* 8514 controller                      */
#define PCI_CLASS_DISPLAY_XGA                       0x0301      /* XGA compatible controller            */
#define PCI_CLASS_DISPLAY_3D                        0x0302      /* 3D controller                        */
#define PCI_CLASS_DISPLAY_OTHER                     0x0380      /* Display controller                   */

#define PCI_BASE_CLASS_MULTIMEDIA                   0x04        /* Multimedia controller                */
#define PCI_CLASS_MULTIMEDIA_VIDEO                  0x0400      /* Multimedia video controller          */
#define PCI_CLASS_MULTIMEDIA_AUDIO                  0x0401      /* Multimedia audio controller          */
#define PCI_CLASS_MULTIMEDIA_PHONE                  0x0402      /* Computer telephony device            */
#define PCI_CLASS_MULTIMEDIA_AUDIO_DEV              0x0403      /* Audio device                         */
#define PCI_CLASS_MULTIMEDIA_OTHER                  0x0480      /* Multimedia controller                */

#define PCI_BASE_CLASS_MEMORY                       0x05        /* Memory controller                    */
#define PCI_CLASS_MEMORY_RAM                        0x0500      /* RAM memory                           */
#define PCI_CLASS_MEMORY_FLASH                      0x0501      /* FLASH memory                         */
#define PCI_CLASS_MEMORY_OTHER                      0x0580      /* Memory controller                    */

#define PCI_BASE_CLASS_BRIDGE                       0x06        /* Bridge                               */
#define PCI_CLASS_BRIDGE_HOST                       0x0600      /* Host bridge                          */
#define PCI_CLASS_BRIDGE_ISA                        0x0601      /* ISA bridge                           */
#define PCI_CLASS_BRIDGE_EISA                       0x0602      /* EISA bridge                          */
#define PCI_CLASS_BRIDGE_MC                         0x0603      /* MicroChannel bridge                  */
#define PCI_CLASS_BRIDGE_PCI                        0x0604      /* PCI bridge                           */
#define PCI_CLASS_BRIDGE_PCI_NORMAL                 0x060400    /* Normal decode                        */
#define PCI_CLASS_BRIDGE_PCI_SUBTRACTIVE            0x060401    /* Subtractive decode                   */
#define PCI_CLASS_BRIDGE_PCMCIA                     0x0605      /* PCMCIA bridge                        */
#define PCI_CLASS_BRIDGE_NUBUS                      0x0606      /* NuBus bridge                         */
#define PCI_CLASS_BRIDGE_CARDBUS                    0x0607      /* CardBus bridge                       */
#define PCI_CLASS_BRIDGE_RACEWAY                    0x0608      /* RACEway bridge                       */
#define PCI_CLASS_BRIDGE_RACEWAY_TRANSPARENT        0x060800    /* Transparent mode                     */
#define PCI_CLASS_BRIDGE_RACEWAY_ENDPOINT           0x060801    /* Endpoint mode                        */
#define PCI_CLASS_BRIDGE_PCI_SEMI                   0x0609      /* Semi-transparent PCI-to-PCI bridge   */
#define PCI_CLASS_BRIDGE_PCI_SEMI_PRIMARY           0x060940    /* Primary bus towards host CPU         */
#define PCI_CLASS_BRIDGE_PCI_SEMI_SECONDARY         0x060980    /* Secondary bus towards host CPU       */
#define PCI_CLASS_BRIDGE_IB_TO_PCI                  0x060a      /* InfiniBand to PCI host bridge        */
#define PCI_CLASS_BRIDGE_OTHER                      0x0680      /* Bridge                               */

#define PCI_BASE_CLASS_COMMUNICATION                0x07        /* Communication controller             */
#define PCI_CLASS_COMMUNICATION_SERIAL              0x0700      /* Serial controller                    */
#define PCI_CLASS_COMMUNICATION_SERIAL_8250         0x070000    /* 8250                                 */
#define PCI_CLASS_COMMUNICATION_SERIAL_16450        0x070001    /* 16450                                */
#define PCI_CLASS_COMMUNICATION_SERIAL_16550        0x070002    /* 16550                                */
#define PCI_CLASS_COMMUNICATION_SERIAL_16650        0x070003    /* 16650                                */
#define PCI_CLASS_COMMUNICATION_SERIAL_16750        0x070004    /* 16750                                */
#define PCI_CLASS_COMMUNICATION_SERIAL_16850        0x070005    /* 16850                                */
#define PCI_CLASS_COMMUNICATION_SERIAL_16950        0x070006    /* 16950                                */
#define PCI_CLASS_COMMUNICATION_PARALLEL            0x0701      /* Parallel controller                  */
#define PCI_CLASS_COMMUNICATION_PARALLEL_SPP        0x070100    /* SPP                                  */
#define PCI_CLASS_COMMUNICATION_PARALLEL_BIDIR      0x070101    /* BiDir                                */
#define PCI_CLASS_COMMUNICATION_PARALLEL_ECP        0x070102    /* ECP                                  */
#define PCI_CLASS_COMMUNICATION_PARALLEL_IEEE1284   0x070103    /* IEEE1284                             */
#define PCI_CLASS_COMMUNICATION_PARALLEL_IEEE1284_T 0x0701fe    /* IEEE1284 Target                      */
#define PCI_CLASS_COMMUNICATION_MULTISERIAL         0x0702      /* Multiport serial controller          */
#define PCI_CLASS_COMMUNICATION_MODEM               0x0703      /* Modem                                */
#define PCI_CLASS_COMMUNICATION_MODEM_GENERIC       0x070300    /* Generic                              */
#define PCI_CLASS_COMMUNICATION_MODEM_HAYES_16450   0x070301    /* Hayes/16450                          */
#define PCI_CLASS_COMMUNICATION_MODEM_HAYES_16550   0x070302    /* Hayes/16550                          */
#define PCI_CLASS_COMMUNICATION_MODEM_HAYES_16650   0x070303    /* Hayes/16650                          */
#define PCI_CLASS_COMMUNICATION_MODEM_HAYES_16750   0x070304    /* Hayes/16750                          */
#define PCI_CLASS_COMMUNICATION_GPIB                0x0704      /* GPIB controller                      */
#define PCI_CLASS_COMMUNICATION_SMARD_CARD          0x0705      /* Smard Card controller                */
#define PCI_CLASS_COMMUNICATION_OTHER               0x0780      /* Communication controller             */

#define PCI_BASE_CLASS_SYSTEM                       0x08        /* Generic system peripheral            */
#define PCI_CLASS_SYSTEM_PIC                        0x0800      /* PIC                                  */
#define PCI_CLASS_SYSTEM_PIC_8259                   0x080000    /* 8259                                 */
#define PCI_CLASS_SYSTEM_PIC_ISA_PIC                0x080001    /* ISA PIC                              */
#define PCI_CLASS_SYSTEM_PIC_EISA_PIC               0x080002    /* EISA PIC                             */
#define PCI_CLASS_SYSTEM_PIC_IO_APIC                0x080010    /* IO-APIC                              */
#define PCI_CLASS_SYSTEM_PIC_IOX_APIC               0x080020    /* IO(X)-APIC                           */
#define PCI_CLASS_SYSTEM_DMA                        0x0801      /* DMA controller                       */
#define PCI_CLASS_SYSTEM_DMA_8237                   0x080100    /* 8237                                 */
#define PCI_CLASS_SYSTEM_DMA_ISA_DAM                0x080101    /* ISA DMA                              */
#define PCI_CLASS_SYSTEM_DMA_EISA_DMA               0x080102    /* EISA DMA                             */
#define PCI_CLASS_SYSTEM_TIMER                      0x0802      /* Timer                                */
#define PCI_CLASS_SYSTEM_TIMER_8254                 0x080200    /* 8254                                 */
#define PCI_CLASS_SYSTEM_TIMER_ISA_TIMER            0x080201    /* ISA Timer                            */
#define PCI_CLASS_SYSTEM_TIMER_EISA_TIMER           0x080202    /* EISA Timers                          */
#define PCI_CLASS_SYSTEM_TIMER_HPET                 0x080203    /* HPET                                 */
#define PCI_CLASS_SYSTEM_RTC                        0x0803      /* RTC                                  */
#define PCI_CLASS_SYSTEM_RTC_GENERIC                0x080300    /* Generic                              */
#define PCI_CLASS_SYSTEM_RTC_ISA_RTC                0x080301    /* ISA RTC                              */
#define PCI_CLASS_SYSTEM_PCI_HOTPLUG                0x0804      /* PCI Hot-plug controller              */
#define PCI_CLASS_SYSTEM_SDHCI                      0x0805      /* SD Host controller                   */
#define PCI_CLASS_SYSTEM_IOMMU                      0x0806      /* IOMMU                                */
#define PCI_CLASS_SYSTEM_OTHER                      0x0880      /* System peripheral                    */

#define PCI_BASE_CLASS_INPUT                        0x09        /* Input device controller              */
#define PCI_CLASS_INPUT_KEYBOARD                    0x0900      /* Keyboard controller                  */
#define PCI_CLASS_INPUT_PEN                         0x0901      /* Digitizer Pen                        */
#define PCI_CLASS_INPUT_MOUSE                       0x0902      /* Mouse controller                     */
#define PCI_CLASS_INPUT_SCANNER                     0x0903      /* Scanner controller                   */
#define PCI_CLASS_INPUT_GAMEPORT                    0x0904      /* Gameport controller                  */
#define PCI_CLASS_INPUT_GAMEPORT_GENERIC            0x090400    /* Generic                              */
#define PCI_CLASS_INPUT_GAMEPORT_EXTENDED           0x090410    /* Extended                             */
#define PCI_CLASS_INPUT_OTHER                       0x0980      /* Input device controller              */

#define PCI_BASE_CLASS_DOCKING                      0x0a        /* Docking station                      */
#define PCI_CLASS_DOCKING_GENERIC                   0x0a00      /* Generic Docking Station              */
#define PCI_CLASS_DOCKING_OTHER                     0x0a80      /* Docking Station                      */

#define PCI_BASE_CLASS_PROCESSOR                    0x0b        /* Processor                            */
...
#define PCI_CLASS_PROCESSOR_ALPHA                   0x0b10      /* Alpha                                */
#define PCI_CLASS_PROCESSOR_POWERPC                 0x0b20      /* Power PC                             */
#define PCI_CLASS_PROCESSOR_MIPS                    0x0b30      /* MIPS                                 */
#define PCI_CLASS_PROCESSOR_CO                      0x0b40      /* Co-processor                         */

#define PCI_BASE_CLASS_SERIAL                       0x0c        /* Serial bus controller                */
#define PCI_CLASS_SERIAL_FIREWIRE                   0x0c00      /* FireWire (IEEE 1394)                 */
#define PCI_CLASS_SERIAL_FIREWIRE_GENERIC           0x0c0000    /* Generic                              */
#define PCI_CLASS_SERIAL_FIREWIRE_OHCI              0x0c0010    /* OHCI                                 */
#define PCI_CLASS_SERIAL_ACCESS                     0x0c01      /* ACCESS Bus                           */
#define PCI_CLASS_SERIAL_SSA                        0x0c02      /* SSA                                  */
#define PCI_CLASS_SERIAL_USB                        0x0c03      /* USB controller                       */
#define PCI_CLASS_SERIAL_USB_UHCI                   0x0c0300    /* UHCI                                 */
#define PCI_CLASS_SERIAL_USB_OHCI                   0x0c0310    /* OHCI                                 */
#define PCI_CLASS_SERIAL_USB_EHCI                   0x0c0320    /* EHCI                                 */
#define PCI_CLASS_SERIAL_USB_XHCI                   0x0c0330    /* XHCI                                 */
#define PCI_CLASS_SERIAL_USB_UNSPECIFIED            0x0c0380    /* Unspecified                          */
#define PCI_CLASS_SERIAL_USB_DEVICE                 0x0c03fe    /* USB Device                           */
#define PCI_CLASS_SERIAL_FIBER                      0x0c04      /* Fibre Channel                        */
#define PCI_CLASS_SERIAL_SMBUS                      0x0c05      /* SMBus                                */
#define PCI_CLASS_SERIAL_INFINIBAND                 0x0c06      /* InfiniBand                           */
#define PCI_CLASS_SERIAL_IPMI                       0x0c07      /* IPMI SMIC interface                  */
#define PCI_CLASS_SERIAL_SERCOS                     0x0c08      /* SERCOS interface                     */
#define PCI_CLASS_SERIAL_CANBUS                     0x0c09      /* CANBUS                               */

#define PCI_BASE_CLASS_WIRELESS                     0x0d        /* Wireless controller                  */
#define PCI_CLASS_WIRELESS_IRDA                     0x0d00      /* IRDA controller                      */
#define PCI_CLASS_WIRELESS_CONSUMER_IR              0x0d01      /* Consumer IR controller               */
#define PCI_CLASS_WIRELESS_RF_CONTROLLER            0x0d10      /* RF controller                        */
#define PCI_CLASS_WIRELESS_WHCI                     0x0d1010
#define PCI_CLASS_WIRELESS_BLUETOOTH                0x0d11      /* Bluetooth                            */
#define PCI_CLASS_WIRELESS_BROADBAND                0x0d12      /* Broadband                            */
#define PCI_CLASS_WIRELESS_802_1A                   0x0d20      /* 802.1a controller                    */
#define PCI_CLASS_WIRELESS_802_1B                   0x0d21      /* 802.1b controller                    */
#define PCI_CLASS_WIRELESS_OTHER                    0x0d80      /* Wireless controller                  */

#define PCI_BASE_CLASS_INTELLIGENT                  0x0e        /* Intelligent controller               */
#define PCI_CLASS_INTELLIGENT_I2O                   0x0e00      /* I2O                                  */

/*
 *  TODO: 注意 subclass 编码与 Linux 不一致
 */
#define PCI_BASE_CLASS_SATELLITE                    0x0f        /* Satellite communications controller  */
#define PCI_CLASS_SATELLITE_TV                      0x0f01      /* Satellite TV controller              */
#define PCI_CLASS_SATELLITE_AUDIO                   0x0f02      /* Satellite audio communication ctl    */
#define PCI_CLASS_SATELLITE_VOICE                   0x0f03      /* Satellite voice communication ctl    */
#define PCI_CLASS_SATELLITE_DATA                    0x0f04      /* Satellite data communication ctl     */

#define PCI_BASE_CLASS_CRYPT                        0x10        /* Encryption controller                */
#define PCI_CLASS_CRYPT_NETWORK                     0x1000      /* Network and computing encryption dev */
#define PCI_CLASS_CRYPT_ENTERTAINMENT               0x1001      /* Entertainment encryption device      */
#define PCI_CLASS_CRYPT_OTHER                       0x1080      /* Encryption controller                */

#define PCI_BASE_CLASS_SIGNAL_PROCESSING            0x11        /* Signal processing controller         */
#define PCI_CLASS_SP_DPIO                           0x1100      /* DPIO module                          */
#define PCI_CLASS_SP_PERF_CTR                       0x1101      /* Performance counters                 */
#define PCI_CLASS_SP_SYNCHRONIZER                   0x1110      /* Communication synchronizer           */
#define PCI_CLASS_SP_MANAGE                         0x1120      /* Signal processing management         */
#define PCI_CLASS_SP_OTHER                          0x1180      /* Signal processing controller         */

#define PCI_BASE_CLASS_PROCESS_ACCELER              0x12        /* Processing accelerators              */
#define PCI_CLASS_PROCESS_ACCELER                   0x1200      /* Processing accelerators              */

#define PCI_BASE_CLASS_NON_ESS_INS                  0x13        /* Non-Essential Instrumentation        */

#define PCI_BASE_CLASS_COPROCESS                    0x40        /* Coprocessor                          */

#define PCI_CLASS_OTHERS                            0xff        /* Unassigned class                     */
...
*********************************************************************************************************/
#define PCI_VENDOR_ID_PEAK                          0x001c
#define PCI_DEVICE_ID_PEAK_PCAN                     0x0001
#define PCI_SUBVENDOR_ID_PEAK_PCAN_SJC1000          0x001c
#define PCI_SUBDEVICE_ID_PEAK_PCAN_SJC1000          0x0004
#define PCI_SUBVENDOR_ID_PEAK_PCAN_SJC1000_OI       0x001c
#define PCI_SUBDEVICE_ID_PEAK_PCAN_SJC1000_OI       0x0005
