...
/* ptr types use long type save/display pointer */
...
intmax_t  lib_strtoimax(const char *, char **, int);
uintmax_t lib_strtoumax(const char *, char **, int);
intmax_t  lib_wcstoimax(const wchar_t *, wchar_t **, int);
uintmax_t lib_wcstoumax(const wchar_t *, wchar_t **, int);

#ifdef __cplusplus
}
#endif

#endif                                                                  /*  __LIB_INTTYPES_H            */
/*********************************************************************************************************
  END
*********************************************************************************************************/
