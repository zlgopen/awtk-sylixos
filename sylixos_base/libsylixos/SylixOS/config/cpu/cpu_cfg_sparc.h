...
#define LW_CFG_SPARC_REG_WIN_NR         8                               /*  CPU 寄存器窗口数目          */
#define LW_CFG_SPARC_CACHE_L2           1                               /*  是否允许管理 SPARC L2 CACHE */
#define LW_CFG_SPARC_LEON_B2BST_NOP     1                               /*  GRLIB-TN-0009 Error         */

/*********************************************************************************************************
  SPARC 指令配置
*********************************************************************************************************/

#define LW_CFG_SPARC_HAS_STBAR_INSTR    1                               /*  是否支持 STBAR 指令         */
