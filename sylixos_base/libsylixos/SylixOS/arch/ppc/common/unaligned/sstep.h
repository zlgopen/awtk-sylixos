 ...
 * otherwise.
 */
extern int analyse_instr(struct instruction_op *op, const ARCH_REG_CTX *regs,
			 unsigned int instr);
 ...
 * fields in *regs.
 */
void emulate_update_regs(ARCH_REG_CTX *reg, struct instruction_op *op);
 ...
 */
extern int emulate_step(ARCH_REG_CTX *regs, unsigned int instr);
 ...
 */
extern int emulate_loadstore(ARCH_REG_CTX *regs, struct instruction_op *op);
...
extern void emulate_vsx_store(struct instruction_op *op,
			      ...
			      bool cross_endian);
extern int emulate_dcbz(unsigned long ea, ARCH_REG_CTX *regs);
/*********************************************************************************************************
  END
*********************************************************************************************************/
