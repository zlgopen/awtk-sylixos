...
#ifndef __ARCH_MIPSIO_H
#define __ARCH_MIPSIO_H

/*********************************************************************************************************
  MIPS 处理器 I/O 屏障 (Non-Cache 区域 SylixOS 未使用低效率的强排序方式, 所以这里需要加入内存屏障)
*********************************************************************************************************/
