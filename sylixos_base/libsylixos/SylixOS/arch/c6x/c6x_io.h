...
**
** 描        述: TI C6X DSP 体系构架 I/O 访问接口.
*********************************************************************************************************/

#ifndef __ARCH_C6X_IO_H
#define __ARCH_C6X_IO_H

#include "endian.h"
#include "common/c6xIo.h"
...
/*********************************************************************************************************
  C6X 处理器 I/O 端口操作 (C6X 处理器没有独立 I/O 端口, 处理方法与 I/O 内存相同)
*********************************************************************************************************/
