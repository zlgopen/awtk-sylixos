...
VOID  archCacheInit (CACHE_MODE  uiInstruction, CACHE_MODE  uiData, CPCHAR  pcMachineName)
{
    ...
    c6xCacheInit(pcacheop, uiInstruction, uiData, pcMachineName);
}
/*********************************************************************************************************
** 函数名称: archCacheReset
...
{
    _DebugFormat(__LOGMESSAGE_LEVEL, "%s L1 cache reset.\r\n", pcMachineName);

    c6xCacheReset(pcMachineName);
}
