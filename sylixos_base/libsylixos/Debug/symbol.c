...
extern int  _ThreadDisjoinWakeup(); 
extern int  _ThreadDisjoinWakeupAll(); 
...
extern int  vprocGetPidByTcbdesc(); 
...
extern int  netdev_pbuf_alloc_ram(); 
...
extern int  aodv_grph_create(); 
extern int  aodv_grph_forward(); 
extern int  aodv_grph_forward_ucast(); 
extern int  aodv_grph_process(); 
extern int  aodv_grph_send(); 
extern int  aodv_mact_activate_best_upstream(); 
extern int  aodv_mact_create(); 
extern int  aodv_mact_make_downstream_leader(); 
extern int  aodv_mact_mcast(); 
extern int  aodv_mact_process(); 
extern int  aodv_mact_send(); 
extern int  aodv_mcast_join(); 
extern int  aodv_mcast_leave(); 
extern int  aodv_mcast_query(); 
extern int  aodv_mcast_rrep_process(); 
extern int  aodv_mcast_rreq_process(); 
extern int  aodv_mcast_rreq_retries(); 
extern int  aodv_mcast_try_send(); 
extern int  aodv_mtunnel_new(); 
extern int  aodv_mtunnel_output(); 
extern int  aodv_mtunnel_remove(); 
extern int  aodv_mcast_neighbor_link_break(); 
extern int  aodv_neighbor_add(); 
extern int  aodv_neighbor_link_break(); 
extern int  aodv_igmp_new(); 
extern int  aodv_igmp_remove(); 
extern int  aodv_igmp_sendreply(); 
extern int  aodv_mproxy_new(); 
extern int  aodv_mproxy_remove(); 
...
extern int  aodv_mrt_become_leader(); 
extern int  aodv_mrt_delete(); 
extern int  aodv_mrt_delete_netif(); 
extern int  aodv_mrt_find(); 
extern int  aodv_mrt_get_activated_upstream(); 
extern int  aodv_mrt_get_best_upstream(); 
extern int  aodv_mrt_init(); 
extern int  aodv_mrt_insert(); 
extern int  aodv_mrt_netif_index_get(); 
extern int  aodv_mrt_nexthop_active(); 
extern int  aodv_mrt_nexthop_add(); 
extern int  aodv_mrt_nexthop_deactive(); 
extern int  aodv_mrt_nexthop_find(); 
extern int  aodv_mrt_nexthop_remove(); 
extern int  aodv_mrt_nexthop_remove_all(); 
extern int  aodv_mrt_origlist_add(); 
extern int  aodv_mrt_origlist_find(); 
extern int  aodv_mrt_origlist_remove(); 
extern int  aodv_mrt_origlist_remove_all(); 
extern int  aodv_mrt_set_leader(); 
extern int  aodv_mrt_set_leader_hcnt(); 
extern int  aodv_mrt_set_membership(); 
extern int  aodv_mrt_source_add(); 
extern int  aodv_mrt_source_find(); 
extern int  aodv_mrt_source_remove_all(); 
extern int  aodv_mrt_start_routing(); 
extern int  aodv_mrt_stop_routing(); 
extern int  aodv_mrt_traversal(); 
extern int  aodv_mrt_update_timeout(); 
...
extern int  aodv_rreq_forward_unicast(); 
...
extern int  aodv_seeklist_find_mcast(); 
extern int  aodv_seeklist_insert(); 
extern int  aodv_seeklist_remove(); 
extern int  aodv_seeklist_remove_mcast(); 
...
extern int  aodv_grph_timeout(); 
extern int  aodv_hello_timeout(); 
extern int  aodv_local_repair_timeout(); 
extern int  aodv_mcast_expire_timeout(); 
extern int  aodv_mcast_prune_dangle(); 
extern int  aodv_mcast_report_up(); 
...
extern int  ppp_dbglog(); 
extern int  ppp_error(); 
extern int  ppp_fatal(); 
extern int  ppp_info(); 
extern int  ppp_notice(); 
...
extern int  API_INetTftpReceive(); 
extern int  API_INetTftpSend(); 
extern int  API_INetTftpServerInit(); 
extern int  API_INetTftpServerPath(); 
...
SYMBOL_TABLE_BEGIN										
    ...
    SYMBOL_ITEM_FUNC(__diskCacheThread) 
    ...
    SYMBOL_ITEM_FUNC(_ThreadDisjoinWakeup) 
    SYMBOL_ITEM_FUNC(_ThreadDisjoinWakeupAll) 
    ...
    SYMBOL_ITEM_FUNC(_ThreadMakeMain) 
    ...
    SYMBOL_ITEM_FUNC(vprocGetPidByTcbdesc) 
    ...
    SYMBOL_ITEM_FUNC(netEventIfAuthTo) 
    ...
    SYMBOL_ITEM_FUNC(netdev_pbuf_alloc_ram) 
    ...
    SYMBOL_ITEM_FUNC(aodv_grph_create) 
    SYMBOL_ITEM_FUNC(aodv_grph_forward) 
    SYMBOL_ITEM_FUNC(aodv_grph_forward_ucast) 
    SYMBOL_ITEM_FUNC(aodv_grph_process) 
    SYMBOL_ITEM_FUNC(aodv_grph_send) 
    SYMBOL_ITEM_FUNC(aodv_mact_activate_best_upstream) 
    SYMBOL_ITEM_FUNC(aodv_mact_create) 
    SYMBOL_ITEM_FUNC(aodv_mact_make_downstream_leader) 
    SYMBOL_ITEM_FUNC(aodv_mact_mcast) 
    SYMBOL_ITEM_FUNC(aodv_mact_process) 
    SYMBOL_ITEM_FUNC(aodv_mact_send) 
    SYMBOL_ITEM_FUNC(aodv_mcast_join) 
    SYMBOL_ITEM_FUNC(aodv_mcast_leave) 
    SYMBOL_ITEM_FUNC(aodv_mcast_query) 
    SYMBOL_ITEM_FUNC(aodv_mcast_rrep_process) 
    SYMBOL_ITEM_FUNC(aodv_mcast_rreq_process) 
    SYMBOL_ITEM_FUNC(aodv_mcast_rreq_retries) 
    SYMBOL_ITEM_FUNC(aodv_mcast_try_send) 
    SYMBOL_ITEM_FUNC(aodv_mtunnel_new) 
    SYMBOL_ITEM_FUNC(aodv_mtunnel_output) 
    SYMBOL_ITEM_FUNC(aodv_mtunnel_remove) 
    SYMBOL_ITEM_FUNC(aodv_mcast_neighbor_link_break) 
    SYMBOL_ITEM_FUNC(aodv_neighbor_add) 
    SYMBOL_ITEM_FUNC(aodv_neighbor_link_break) 
    SYMBOL_ITEM_FUNC(aodv_igmp_new) 
    SYMBOL_ITEM_FUNC(aodv_igmp_remove) 
    SYMBOL_ITEM_FUNC(aodv_igmp_sendreply) 
    SYMBOL_ITEM_FUNC(aodv_mproxy_new) 
    SYMBOL_ITEM_FUNC(aodv_mproxy_remove) 
    ...
    SYMBOL_ITEM_FUNC(aodv_mrt_become_leader) 
    SYMBOL_ITEM_FUNC(aodv_mrt_delete) 
    SYMBOL_ITEM_FUNC(aodv_mrt_delete_netif) 
    SYMBOL_ITEM_FUNC(aodv_mrt_find) 
    SYMBOL_ITEM_FUNC(aodv_mrt_get_activated_upstream) 
    SYMBOL_ITEM_FUNC(aodv_mrt_get_best_upstream) 
    SYMBOL_ITEM_FUNC(aodv_mrt_init) 
    SYMBOL_ITEM_FUNC(aodv_mrt_insert) 
    SYMBOL_ITEM_FUNC(aodv_mrt_netif_index_get) 
    SYMBOL_ITEM_FUNC(aodv_mrt_nexthop_active) 
    SYMBOL_ITEM_FUNC(aodv_mrt_nexthop_add) 
    SYMBOL_ITEM_FUNC(aodv_mrt_nexthop_deactive) 
    SYMBOL_ITEM_FUNC(aodv_mrt_nexthop_find) 
    SYMBOL_ITEM_FUNC(aodv_mrt_nexthop_remove) 
    SYMBOL_ITEM_FUNC(aodv_mrt_nexthop_remove_all) 
    SYMBOL_ITEM_FUNC(aodv_mrt_origlist_add) 
    SYMBOL_ITEM_FUNC(aodv_mrt_origlist_find) 
    SYMBOL_ITEM_FUNC(aodv_mrt_origlist_remove) 
    SYMBOL_ITEM_FUNC(aodv_mrt_origlist_remove_all) 
    SYMBOL_ITEM_FUNC(aodv_mrt_set_leader) 
    SYMBOL_ITEM_FUNC(aodv_mrt_set_leader_hcnt) 
    SYMBOL_ITEM_FUNC(aodv_mrt_set_membership) 
    SYMBOL_ITEM_FUNC(aodv_mrt_source_add) 
    SYMBOL_ITEM_FUNC(aodv_mrt_source_find) 
    SYMBOL_ITEM_FUNC(aodv_mrt_source_remove_all) 
    SYMBOL_ITEM_FUNC(aodv_mrt_start_routing) 
    SYMBOL_ITEM_FUNC(aodv_mrt_stop_routing) 
    SYMBOL_ITEM_FUNC(aodv_mrt_traversal) 
    SYMBOL_ITEM_FUNC(aodv_mrt_update_timeout) 
    ...
    SYMBOL_ITEM_FUNC(aodv_rreq_forward_unicast) 
    ...
    SYMBOL_ITEM_FUNC(aodv_seeklist_find_mcast) 
    SYMBOL_ITEM_FUNC(aodv_seeklist_insert) 
    SYMBOL_ITEM_FUNC(aodv_seeklist_remove) 
    SYMBOL_ITEM_FUNC(aodv_seeklist_remove_mcast) 
    ...
    SYMBOL_ITEM_FUNC(aodv_grph_timeout) 
    SYMBOL_ITEM_FUNC(aodv_hello_timeout) 
    SYMBOL_ITEM_FUNC(aodv_local_repair_timeout) 
    SYMBOL_ITEM_FUNC(aodv_mcast_expire_timeout) 
    SYMBOL_ITEM_FUNC(aodv_mcast_prune_dangle) 
    SYMBOL_ITEM_FUNC(aodv_mcast_report_up) 
    ...
    SYMBOL_ITEM_FUNC(ppp_dbglog) 
    SYMBOL_ITEM_FUNC(ppp_error) 
    SYMBOL_ITEM_FUNC(ppp_fatal) 
    SYMBOL_ITEM_FUNC(ppp_info) 
    SYMBOL_ITEM_FUNC(ppp_notice) 
    ...
    SYMBOL_ITEM_FUNC(API_INetTftpReceive) 
    SYMBOL_ITEM_FUNC(API_INetTftpSend) 
    SYMBOL_ITEM_FUNC(API_INetTftpServerInit) 
    SYMBOL_ITEM_FUNC(API_INetTftpServerPath) 
    ...
    SYMBOL_ITEM_FUNC(API_TShellSetTitel) 
    ...
    SYMBOL_ITEM_FUNC(API_PciDrvDelete) 
    ...
    SYMBOL_ITEM_OBJ(_G_cTftpErrorMsg) 
    ...
    SYMBOL_ITEM_OBJ(_K_i64KernelTime) 
